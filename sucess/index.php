...
if(isset($_POST['submit']) and !empty($_POST['submit'])){
    ...
    $mail1_subject="Black or White Concepts Enquiry from Google Ads, " . $name;
    $mail1_txt="Name :" . $name . "<br>" . "Company Name :" . $companyname . "<br>" . "Enquiry :" . $enquiry . "<br>" . "Mobile :" . $phone . "<br>" . "E-Mail :" . $email . "<br>" . "Source :" . $esource . "<br>" . "Medium :" . $emedium . "<br>" . "IP :" . $ip . "<br>";
    ...
    $apiKey = urlencode('5WH1Btb6Jr7eHSTC');
    $agent = "49806091";
...
<p><i class="fa fa-phone" aria-hidden="true"></i> +971 52 815 5771 </p>
</div>
